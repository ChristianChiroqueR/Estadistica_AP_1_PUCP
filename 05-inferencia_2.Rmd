...
### Paso 2: Ver distribución muestral

![](figures/detective_escena.jpg)

> Antes de ver los hechos, debemos ver el contexto en el cual se encuentran. No es lo mismo que el investigado sea joven que adulto. Entender previamente estas características nos permitirá investigar mejor! Es nuestra escena del crimen!
...
En este caso debemos corroborar una característica: que las varianzas poblacionales sean iguales. Es decir, que la curva de distribución muestral en cada grupo analizado sea homogénea. Si son iguales, el camino de la investigación se dirigirá por un lado, si es diferente irá por otro. 
