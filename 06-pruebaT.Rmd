...
Abrir la base de datos. Vamos a seguir usando [enades](https://iep.org.pe/wp-content/uploads/2022/08/Cuestionario-Oxfam-IEP.-ENADES-2022-final.pdf): 
...
### A tener en cuenta: PH para igualdad de varianzas

Para poder verificar este supuesto de homogenedidad de varianzas de forma rigurosa podemos aplicar una **Prueba de Levene de Homogeneidad de Varianzas**.

```{r message=FALSE, warning=FALSE}
library(DescTools)
LeveneTest(enades$p08, enades$area2)$"Pr(>F)"
```
Hipótesis  | Descripción | Notación
------------- | ------------- | -------------
